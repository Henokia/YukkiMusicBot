...
⚡️ __Searched Powered By {config.MUSIC_BOT_NAME}__"""
        ...
        if config.START_IMG_URL:
          try:
              app = await message.reply_text(f"**ᴅιиg ᴅσиg ꨄ︎❣️.....**")
              await app.edit_text(f"**ᴅιиg ᴅσиg ꨄ︎.❣️....**")
              await app.edit_text(f"**ᴅιиg ᴅσиg ꨄ︎..❣️...**")
              await app.edit_text(f"**ᴅιиg ᴅσиg ꨄ︎...❣️..**")
              await app.edit_text(f"**ᴅιиg ᴅσиg ꨄ︎....❣️.**")
              await app.edit_text(f"**ᴅιиg ᴅσиg ꨄ︎.....❣️**")
              await app.delete()
              apps = await message.reply_text("**⚡ѕ**")
              await asyncio.sleep(0.1)
              await apps.edit_text("**⚡ѕт**")
              await asyncio.sleep(0.1)
              await apps.edit_text("**⚡ѕтα**")
              await asyncio.sleep(0.1)
              await apps.edit_text("**⚡ѕтαя**")
              await asyncio.sleep(0.1)
              await apps.edit_text("**⚡ѕтαят**")
              await asyncio.sleep(0.1)
              await apps.edit_text("**⚡ѕтαятι**")
              await asyncio.sleep(0.1)
              await apps.edit_text("**⚡ѕтαятιи**")
              await asyncio.sleep(0.1)
              await apps.edit_text("**⚡ѕтαятιиg**")
              await asyncio.sleep(0.1)
              await apps.edit_text("**⚡ѕтαятιиg.**")
              await asyncio.sleep(0.1)
              await apps.edit_text("**⚡ѕтαятιиg....**")
